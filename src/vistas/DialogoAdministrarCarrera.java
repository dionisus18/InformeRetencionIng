...
class DialogoAdministrarCarrera extends JDialog
    ...
    private String btnString1 = "Enviar";
    ...
    public DialogoAdministrarCarrera(Frame aFrame, String aWord, String jlabeltitle, dashboardRetencion parent) {
        super(aFrame, true);
        dd = parent;
         ...
         && (JOptionPane.VALUE_PROPERTY.equals(prop) ||
            ...
            if (btnString1.equals(value)) {
                ...
                if (magicWord.equals(ucText)) {
                    ...
                    //text was invalid
                    textField.selectAll();
                    JOptionPane.showMessageDialog(DialogoAdministrarCarrera.this,
                                    "Sorry, \"" + typedText + "\" "
